          ...
          {review.map((user, index) => (
            <div className="card" key={index}>
              <div className="h-[40%] w-[100%]">
                <h4 className="text-[2.5vw] md:text-[1.1vw] font-light">{user.name}</h4>
                <h2 className=" text-[3vw] md:text-[1.2vw] font-medium">
                  - {user.position} at {user.company}
                </h2>
              </div>
              <p className=" w-[70%] text-[2.8vw] md:text-[1vw] flex gap-2">
                <FaQuoteLeft className=" quote text-[2.8vw] md:text-[1vw]" />
                {user.testimonial}
              </p>
            </div>
          ))}
